...
import Addstocks from '../Components/Addstocks/Addstocks';
 ...
 class Main extends Component {
     ...
     componentDidMount(){
        axios.get("https://financeportfolio-33c58.firebaseio.com/company.json")
        .then((response)=>{
        ...
        axios.get("https://financeportfolio-33c58.firebaseio.com/myStocks.json")
        .then((response)=>{
    ...
    removeStock=(index)=>{
        ...
        let companySymbol=this.state.myStocks[index]["Company_Symbol"];
            ...
            axios.post('https://financeportfolio-33c58.firebaseio.com/company.json', {
                name:companyName,
            ...
            //Deleting stocks from my Stocks
             axios.delete(`https://financeportfolio-33c58.firebaseio.com/myStocks/${id}.json`)
             .then((response)=>{
        ...
        addDatatoFirebase=(a,b,c)=>
        {
            ...
            let buyDate=document.getElementById("buyDate").value;
                    if(noofshares>0&&buyPrice.length>0&&buyDate.length>0)
                    {
                            ...
                            axios.post('https://financeportfolio-33c58.firebaseio.com/myStocks.json', {
                            ...
                            axios.delete(`https://financeportfolio-33c58.firebaseio.com/company/${id}.json`)
                            .then((response)=>{
